...
with DAG(
    ...
    with TaskGroup(group_id = 'dim_group') as dim_group:
        dim_group = [
            'creating_bridge_allergy_group'
            , 'creating_bridge_care_plan_group'
            , 'creating_bridge_condition_group'
            , 'creating_bridge_device_group'
            , 'creating_bridge_imaging_study_group'
            , 'creating_bridge_immunization_group'
            , 'creating_bridge_medication_group'
            , 'creating_bridge_observation_group'
            , 'creating_bridge_procedure_group'
            , 'creating_bridge_supply_group'
            , 'creating_dim_allergies'
            , 'creating_dim_allergy_group'            
            , 'creating_dim_care_plans'          
            , 'creating_dim_conditions'
            , 'creating_dim_condition_group'            
            , 'creating_dim_date'
            , 'creating_dim_devices'
            , 'creating_dim_device_group'            
            , 'creating_dim_encounter_codes'
            , 'creating_dim_encounter_reason_codes'
            , 'creating_dim_imaging_studies'
            , 'creating_dim_imaging_study_group'            
            , 'creating_dim_immunizations'
            , 'creating_dim_immunization_group'            
            , 'creating_dim_medications'
            , 'creating_dim_medication_group'
            , 'creating_dim_observations'
            , 'creating_dim_observation_group'
            , 'creating_dim_organizations'
            , 'creating_dim_patients'
            , 'creating_dim_payers'
            , 'creating_dim_procedures'
            , 'creating_dim_procedure_group'
            , 'creating_dim_providers'
            , 'creating_dim_supplies'
            , 'creating_dim_supply_group'
            , 'creating_dim_time'
        ]
